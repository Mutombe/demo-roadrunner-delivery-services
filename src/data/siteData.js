...
const siteData = {
  business: {
    ...
    legalName: "Roadrunner Delivery Services",
    tagline: "Delivering Excellence Across Zimbabwe",
    description: "Founded with a belief that Zimbabwe deserves world-class logistics, Roadrunner Delivery Services has grown from a single delivery van into one of Harare's most trusted courier and freight companies.",
    phone: "+263 78 995 5723",
    phoneRaw: "+263789955723",
    whatsappNumber: "263789955723",
    email: "info@roadrunnerdeliveryse.co.zw",
    address: "55 five Ave, Harare, Zimbabwe",
    country: "Zimbabwe",
    city: "Harare",
    rating: 5,
    ratingRounded: 5,
    ...
    cookieConsentKey: "roadrunner-delivery-services-cookie-consent",
    socialLinks: { facebook: "", instagram: "#", linkedin: "#" },
  },

  navbar: { logoImage: null, logoLine1: "Roadrunner", logoLine2: "Delivery Services" },
  ...
  homeTestimonials: [
    { text: "We switched to Roadrunner Delivery Services six months ago and our delivery complaints dropped to almost zero. The real-time tracking gives our customers confidence.", name: "Tendai Moyo", role: "E-Commerce Director", rating: 5, avatar: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" },
    { text: "Same-day delivery in Harare that actually works. Roadrunner Delivery Services has been a game-changer for our pharmacy business.", name: "Rudo Nhemachena", role: "Pharmacy Owner", rating: 5, avatar: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80" },
    { text: "Reliable, professional, and always on time. Roadrunner Delivery Services handles all our corporate logistics and we could not be happier.", name: "James Karanga", role: "Operations Manager", rating: 5, avatar: "https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=100&q=80" },
  ...
  about: {
    ...
    story: [
      "Founded with a belief that Zimbabwe deserves world-class logistics, Roadrunner Delivery Services has grown from a single delivery van into one of Harare's most trusted courier and freight companies.",
  ...
  reviews: {
    ...
    items: [
      { text: "We switched to Roadrunner Delivery Services six months ago and our delivery complaints dropped to almost zero. The real-time tracking gives our customers confidence.", name: "Tendai Moyo", role: "E-Commerce Director", rating: 5 },
      { text: "Same-day delivery in Harare that actually works. Roadrunner Delivery Services has been a game-changer for our pharmacy business.", name: "Rudo Nhemachena", role: "Pharmacy Owner", rating: 5 },
      { text: "Reliable, professional, and always on time. Roadrunner Delivery Services handles all our corporate logistics and we could not be happier.", name: "James Karanga", role: "Operations Manager", rating: 5 },
      ...
      { text: "Outstanding service from start to finish. Roadrunner Delivery Services exceeded all our expectations.", name: "Memory Dube", role: "Satisfied Customer", rating: 5 },
      { text: "Professional, reliable, and great value for money. I recommend Roadrunner Delivery Services to everyone.", name: "Tafadzwa Chikumba", role: "Regular Client", rating: 5 },
      { text: "The team at Roadrunner Delivery Services is knowledgeable and always willing to go the extra mile.", name: "Chenai Manyika", role: "Business Owner", rating: 5 },
      { text: "Consistently excellent service. Roadrunner Delivery Services has been our trusted partner for years.", name: "Patrick Nhamo", role: "Property Manager", rating: 5 },
    ],
  },
  ...
  homeCta: {
    ...
    whatsappText: "Hi Roadrunner Delivery Services! I would like to request a quote.",
